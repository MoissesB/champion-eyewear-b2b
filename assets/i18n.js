(function () {
  ...
  const translations = {
    es: {
      ...
      sunKicker: 'Champion Sun · Nueva categoría', sunTitle: 'Lentes de sol para una vitrina más deportiva', sunIntro: 'Una sección completa con 29 referencias solares, desde siluetas urbanas hasta pantallas envolventes de alto impacto.', sunAvailable: 'referencias disponibles para el pedido', sunFiltersAria: 'Filtros de lentes de sol', sunSearch: 'Buscar lentes de sol', sunPlaceholder: 'Buscar CHS-07, azul, espejado…', allMasculine: 'Todos',
