(function () {
  ...
  const translations = {
    es: {
      ...
      processKicker: 'Pedido para ópticas', processTitle: 'De la selección al pedido para revisión', processIntro: 'Un proceso claro para ópticas, cadenas y distribuidores. Innova revisa la óptica, confirma el pedido, realiza el cobro y coordina el envío.', step1Title: 'Seleccione', step1Text: 'Añada monturas o solares y ajuste la cantidad de cada referencia.', step2Title: 'Complete', step2Text: 'Indique nombre, óptica, correo, teléfono, ciudad y país.', step3Title: 'Revise', step3Text: 'Cumpla el mínimo de 18 piezas. La referencia general para 18 piezas es US$1,080.', step4Title: 'Envíe el pedido', step4Text: 'Envíe el pedido completo por WhatsApp o correo. Innova confirmará disponibilidad, cobro y envío; no se ofrece envío gratuito.',
      referenceKicker: 'Referencia comercial', referenceTitle: 'Pedido inicial mínimo: 18 piezas', referenceText: 'El valor de referencia aprobado es US$60 por pieza, por lo que 18 piezas equivalen a una referencia general de US$1,080. No mostramos precios por producto: el valor final depende del país, disponibilidad, volumen y validación de Innova.', referenceDisclaimer: 'Esta cifra es informativa y no constituye un importe final ni confirma inventario.',
      ...
      ctaKicker: 'Atención de Innova Eyewear', ctaTitle: 'Prepare su próximo pedido Champion', ctaText: 'Seleccione al menos 18 piezas y envíe el pedido completo para que Innova revise la óptica, confirme disponibilidad, realice el cobro y coordine el envío.', ctaOpen: 'Abrir mi pedido', ctaAdvisor: 'Contactar a un asesor',
      footerText: 'Catálogo profesional distribuido por Innova Eyewear.', footerCatalog: 'Catálogo', footerService: 'Pedidos para ópticas', footerRequest: 'Preparar pedido', footerConditions: 'Condiciones', footerPrice: 'Precio final y disponibilidad: a cotizar', footerMinimum: 'Pedido inicial mínimo: 18 piezas', footerOrderReview: 'Innova revisa y confirma el pedido', footerShipping: 'El envío se coordina con el cliente y no es gratuito', footerContact: 'Contacto',
      ...
      viewDetails: 'Ver ficha', addRequest: 'Añadir a mi pedido', added: '{model} añadido a su pedido', noMatchesTitle: 'No encontramos coincidencias.', noMatchesText: 'Pruebe otro modelo, color o material.', opticalOne: 'montura', opticalMany: 'monturas', sunOne: 'lente de sol', sunMany: 'lentes de sol', inCollection: 'en',
      breadcrumbs: 'Migas de pan', productViews: 'Vistas del producto', viewNumber: 'Vista {number}', zoomOut: 'Alejar imagen', zoomReset: 'Restablecer zoom', zoomIn: 'Acercar imagen', variants: 'Colores de {series}', viewColorVariant: 'Ver color {color}', currentColorVariant: 'Color seleccionado: {color}', requestedQuantity: 'Cantidad para el pedido', reviewSelection: 'Revisar mi pedido', orderWhatsapp: 'Enviar pedido por WhatsApp', orderEmail: 'Enviar pedido por correo', directConsultationNote: 'Estos botones abren el pedido completo. Para enviarlo debe seleccionar productos, cumplir 18 piezas y completar los datos de la óptica.', emailInnova: 'Correo a Innova', tabsAria: 'Información de producto', tabDescription: 'Descripción', tabSpecs: 'Ficha técnica', tabTerms: 'Condiciones del pedido', termIntro: 'Esta ficha pertenece a un catálogo profesional. Los productos seleccionados forman un pedido para revisión de Innova; el pedido se confirma después de validar la óptica y la disponibilidad.', term1: 'Innova revisará la óptica y confirmará el pedido.', term2: 'Pedido inicial mínimo de 18 piezas y condiciones según volumen.', term3: 'El cobro y el envío se coordinan con el cliente. No se ofrece envío gratuito.', productFaqKicker: 'Antes de enviar el pedido', productFaqTitle: 'Resuelva aquí sus preguntas', productFaqIntro: 'Compra mínima, proceso de revisión, garantía, cobertura, despacho y condiciones comerciales en un solo lugar.', specModel: 'Modelo', specSku: 'SKU', specCollection: 'Colección', specColor: 'Color', specMaterial: 'Material', specShape: 'Forma', specType: 'Tipo', specProtection: 'Protección', specCompatibility: 'Compatibilidad', specMeasurements: 'Medidas', productNotFoundKicker: 'Referencia no encontrada', productNotFoundTitle: 'Este producto no existe en el catálogo', productNotFoundText: 'Regrese al catálogo para seleccionar una referencia disponible.', productNotFoundCta: 'Volver al catálogo', moreSun: 'Más referencias solares', moreOptical: 'Más referencias ópticas'
    },
    en: {
      ...
      ctaKicker: 'Innova Eyewear support', ctaTitle: 'Prepare your next Champion order', ctaText: 'Select at least 18 pieces and send the complete order so Innova can review the optical store, confirm availability, process payment and coordinate shipping.', ctaOpen: 'Open my order', ctaAdvisor: 'Contact an advisor',
      footerText: 'Professional catalog distributed by Innova Eyewear.', footerCatalog: 'Catalog', footerService: 'Optical-store orders', footerRequest: 'Prepare order', footerConditions: 'Terms', footerPrice: 'Final price and availability: by quotation', footerMinimum: 'Initial minimum order: 18 pieces', footerOrderReview: 'Innova reviews and confirms the order', footerShipping: 'Shipping is coordinated with the customer and is not free', footerContact: 'Contact',
      ...
      viewDetails: 'View details', addRequest: 'Add to my order', added: '{model} added to your order', noMatchesTitle: 'No matches found.', noMatchesText: 'Try another model, color or material.', opticalOne: 'optical frame', opticalMany: 'optical frames', sunOne: 'sunglass', sunMany: 'sunglasses', inCollection: 'in',
      breadcrumbs: 'Breadcrumbs', productViews: 'Product views', viewNumber: 'View {number}', zoomOut: 'Zoom out', zoomReset: 'Reset zoom', zoomIn: 'Zoom in', variants: '{series} colors', viewColorVariant: 'View {color}', currentColorVariant: 'Selected color: {color}', requestedQuantity: 'Order quantity', reviewSelection: 'Review my order', orderWhatsapp: 'Send order by WhatsApp', orderEmail: 'Send order by email', directConsultationNote: 'These buttons open the complete order. To send it, select products, meet the 18-piece minimum and complete the optical-store details.', emailInnova: 'Email Innova', tabsAria: 'Product information', tabDescription: 'Description', tabSpecs: 'Technical details', tabTerms: 'Order terms', termIntro: 'This page belongs to a professional catalog. Selected products form an order for Innova review; the order is confirmed after validating the optical store and availability.', term1: 'Innova will review the optical store and confirm the order.', term2: 'Initial minimum order of 18 pieces and volume-based terms.', term3: 'Payment and shipping are coordinated with the customer. Free shipping is not offered.', productFaqKicker: 'Before sending the order', productFaqTitle: 'Find answers to your questions', productFaqIntro: 'Minimum order, review process, warranty, coverage, dispatch and commercial terms in one place.', specModel: 'Model', specSku: 'SKU', specCollection: 'Collection', specColor: 'Color', specMaterial: 'Material', specShape: 'Shape', specType: 'Type', specProtection: 'Protection', specCompatibility: 'Compatibility', specMeasurements: 'Measurements', productNotFoundKicker: 'Reference not found', productNotFoundTitle: 'This product is not in the catalog', productNotFoundText: 'Return to the catalog to select an available reference.', productNotFoundCta: 'Back to catalog', moreSun: 'More sunglasses references', moreOptical: 'More optical references'
    }
  };

  const faq = {
    es: [
      { id: 'profit', title: 'Rentabilidad y pedidos', intro: 'Precio de referencia, mínimo inicial y estructura del catálogo para preparar un pedido profesional.', items: [
        ...
        ['¿Cuántos productos incluye el catálogo Champion?', 'El catálogo reúne 100 referencias: 64 monturas ópticas y 36 lentes de sol, todas disponibles para consulta comercial desde una plantilla única de producto.'],
      ...
      { id: 'coverage', title: 'Cobertura y proceso comercial', intro: 'Zonas autorizadas, perfil de comprador y pasos para recibir atención comercial.', items: [
        ...
        ['¿Qué pasa después de enviar mi pedido?', 'Un asesor de Innova contactará al cliente para revisar la óptica, confirmar disponibilidad e importe final, realizar el cobro y coordinar el envío. El envío no es gratuito y su costo se confirma según destino y volumen.'],
    ...
    en: [
      { id: 'profit', title: 'Profitability and orders', intro: 'Reference value, initial minimum and catalog structure for a professional order.', items: [
        ...
        ['How many products does the Champion catalog include?', 'The catalog brings together 100 references: 64 optical frames and 36 sunglasses, all available for commercial inquiry through one product template.'],
      ...
      { id: 'coverage', title: 'Coverage and sales process', intro: 'Authorized zones, buyer profile and steps to receive commercial support.', items: [
        ...
        ['What happens after I send my order?', 'An Innova advisor will contact the customer to review the optical store, confirm availability and the final amount, process payment and coordinate shipping. Shipping is not free; its cost is confirmed according to destination and volume.'],
