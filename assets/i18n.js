(function () {
  ...
  const translations = {
    es: {
      ...
      referenceTitle: 'Pedido inicial mínimo: 24 piezas',
      ...
      ctaKicker: 'Atención de Innova Eyewear', ctaTitle: 'Prepare su próximo pedido Champion', ctaText: 'Seleccione al menos 24 piezas y envíe el pedido completo para que Innova revise la óptica, confirme disponibilidad, realice el cobro y coordine el envío.', ctaOpen: 'Abrir mi pedido', ctaAdvisor: 'Contactar a un asesor',
      footerText: 'Catálogo profesional distribuido por Innova Eyewear.', footerCatalog: 'Catálogo', footerService: 'Pedidos para ópticas', footerRequest: 'Preparar pedido', footerConditions: 'Condiciones del pedido', footerMinimum: 'Pedido inicial mínimo: 24 piezas', footerMix: 'Combine modelos, colores y cantidades', footerIndex: 'Índice completo', footerContact: 'Contacto',
      ...
      breadcrumbs: 'Migas de pan', productViews: 'Vistas del producto', viewNumber: 'Vista {number}', zoomOut: 'Alejar imagen', zoomReset: 'Restablecer zoom', zoomIn: 'Acercar imagen', variants: 'Colores de {series}', viewColorVariant: 'Ver color {color}', currentColorVariant: 'Color seleccionado: {color}', requestedQuantity: 'Cantidad para el pedido', reviewSelection: 'Revisar mi pedido', orderWhatsapp: 'Enviar pedido por WhatsApp', orderEmail: 'Enviar pedido por correo', directConsultationNote: 'Estos botones abren el pedido completo. Para enviarlo debe seleccionar productos, cumplir 24 piezas y completar los datos de la óptica.', emailInnova: 'Correo a Innova', tabsAria: 'Información de producto', tabDescription: 'Descripción', tabSpecs: 'Ficha técnica', tabTerms: 'Condiciones del pedido', termIntro: 'Esta ficha pertenece a un catálogo profesional. Los productos seleccionados forman un pedido para revisión de Innova; el pedido se confirma después de validar la óptica y la disponibilidad.', term1: 'Innova revisará la óptica y confirmará el pedido.', term2: 'El pedido inicial debe sumar al menos 24 piezas.', term3: 'Puede combinar modelos, colores y cantidades para completar las 24 piezas.', productFaqKicker: 'Antes de enviar el pedido', productFaqTitle: 'Resuelva aquí sus preguntas', productFaqIntro: 'Pedido inicial de 24 piezas, proceso de revisión, garantía, cobertura, despacho y condiciones comerciales en un solo lugar.', specModel: 'Modelo', specSku: 'SKU', specCollection: 'Colección', specColor: 'Color', specMaterial: 'Material', specShape: 'Forma', specType: 'Tipo', specProtection: 'Protección', specCompatibility: 'Compatibilidad', specMeasurements: 'Medidas', productNotFoundKicker: 'Referencia no encontrada', productNotFoundTitle: 'Este producto no existe en el catálogo', productNotFoundText: 'Regrese al catálogo para seleccionar una referencia disponible.', productNotFoundCta: 'Volver al catálogo', moreSun: 'Más referencias solares', moreOptical: 'Más referencias ópticas'
    },
    en: {
      ...
      referenceTitle: 'Initial minimum order: 24 pieces',
      ...
      ctaKicker: 'Innova Eyewear support', ctaTitle: 'Prepare your next Champion order', ctaText: 'Select at least 24 pieces and send the complete order so Innova can review the optical store, confirm availability, process payment and coordinate shipping.', ctaOpen: 'Open my order', ctaAdvisor: 'Contact an advisor',
      footerText: 'Professional catalog distributed by Innova Eyewear.', footerCatalog: 'Catalog', footerService: 'Optical-store orders', footerRequest: 'Prepare order', footerConditions: 'Order requirements', footerMinimum: 'Initial minimum order: 24 pieces', footerMix: 'Combine models, colors and quantities', footerIndex: 'Full index', footerContact: 'Contact',
      ...
      breadcrumbs: 'Breadcrumbs', productViews: 'Product views', viewNumber: 'View {number}', zoomOut: 'Zoom out', zoomReset: 'Reset zoom', zoomIn: 'Zoom in', variants: '{series} colors', viewColorVariant: 'View {color}', currentColorVariant: 'Selected color: {color}', requestedQuantity: 'Order quantity', reviewSelection: 'Review my order', orderWhatsapp: 'Send order by WhatsApp', orderEmail: 'Send order by email', directConsultationNote: 'These buttons open the complete order. To send it, select products, meet the 24-piece minimum and complete the optical-store details.', emailInnova: 'Email Innova', tabsAria: 'Product information', tabDescription: 'Description', tabSpecs: 'Technical details', tabTerms: 'Order terms', termIntro: 'This page belongs to a professional catalog. Selected products form an order for Innova review; the order is confirmed after validating the optical store and availability.', term1: 'Innova will review the optical store and confirm the order.', term2: 'The initial order must include at least 24 pieces.', term3: 'You can combine models, colors and quantities to reach 24 pieces.', productFaqKicker: 'Before sending the order', productFaqTitle: 'Find answers to your questions', productFaqIntro: 'Initial 24-piece order, review process, warranty, coverage, dispatch and commercial terms in one place.', specModel: 'Model', specSku: 'SKU', specCollection: 'Collection', specColor: 'Color', specMaterial: 'Material', specShape: 'Shape', specType: 'Type', specProtection: 'Protection', specCompatibility: 'Compatibility', specMeasurements: 'Measurements', productNotFoundKicker: 'Reference not found', productNotFoundTitle: 'This product is not in the catalog', productNotFoundText: 'Return to the catalog to select an available reference.', productNotFoundCta: 'Back to catalog', moreSun: 'More sunglasses references', moreOptical: 'More optical references'
    }
  };
  ...
  const faq = {
    es: [
      ...
      { id: 'logistics', title: 'Logística y entregas', intro: '', items: [
        ...
        ['¿Cómo se coordina el envío?', 'Las condiciones de envío dependen del país, ciudad, volumen y coordinación logística vigente. El equipo comercial confirma el proceso según el destino.'],
      ...
      { id: 'coverage', title: 'Cobertura y proceso comercial', intro: 'Zonas autorizadas, perfil de comprador y pasos para recibir atención comercial.', items: [
        ...
        ['¿Qué pasa después de enviar mi pedido?', 'Un asesor de Innova contactará al cliente para revisar la óptica, confirmar disponibilidad, realizar el cobro y coordinar el envío. Las condiciones logísticas se confirman según destino y volumen.'],
        ['¿Puedo hablar con un asesor antes de comprar?', 'Sí. Puede contactar por WhatsApp, correo o solicitar una llamada para revisar catálogo, pedido inicial de 24 piezas, disponibilidad, despacho y condiciones comerciales.']
      ]}
    ],
    en: [
      ...
      { id: 'logistics', title: 'Logistics and deliveries', intro: '', items: [
        ...
        ['How is shipping coordinated?', 'Shipping arrangements depend on the country, city, volume and current logistics coordination. The commercial team confirms the process for each destination.'],
      ...
      { id: 'coverage', title: 'Coverage and sales process', intro: 'Authorized zones, buyer profile and steps to receive commercial support.', items: [
        ...
        ['What happens after I send my order?', 'An Innova advisor will contact the customer to review the optical store, confirm availability, process payment and coordinate shipping. Logistics arrangements are confirmed according to destination and volume.'],
        ['Can I speak with an advisor before buying?', 'Yes. You can contact us by WhatsApp, email or request a call to review the catalog, initial 24-piece order, availability, dispatch and commercial terms.']
      ]}
    ]
  };
