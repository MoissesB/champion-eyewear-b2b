(function () {
  ...
  const translations = {
    ...
    en: {
      ...
      footerText: 'Professional catalog distributed by Innova Eyewear.', footerCatalog: 'Catalog', footerService: 'Optical-store orders', footerRequest: 'Prepare order', footerConditions: 'Order requirements', footerMinimum: 'Initial minimum order: 18 pieces', footerMix: 'Combine models, colors and quantities', footerContact: 'Contact',
