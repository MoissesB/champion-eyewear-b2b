(function () {
  ...
  const translations = {
    es: {
      ...
      footerText: 'Catálogo profesional distribuido por Innova Eyewear.', footerCatalog: 'Catálogo', footerService: 'Pedidos para ópticas', footerRequest: 'Preparar pedido', footerConditions: 'Condiciones del pedido', footerMinimum: 'Pedido inicial mínimo: 18 piezas', footerMix: 'Combine modelos, colores y cantidades', footerIndex: 'Índice completo', footerContact: 'Contacto',
    ...
    en: {
      ...
      footerText: 'Professional catalog distributed by Innova Eyewear.', footerCatalog: 'Catalog', footerService: 'Optical-store orders', footerRequest: 'Prepare order', footerConditions: 'Order requirements', footerMinimum: 'Initial minimum order: 18 pieces', footerMix: 'Combine models, colors and quantities', footerIndex: 'Full index', footerContact: 'Contact',
