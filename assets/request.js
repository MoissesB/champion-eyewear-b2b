(function () {
  ...
  function professionalMessage(attachmentKey) {
    ...
    const closing = isEs ? 'Quedo atento/a al contacto de Innova para revisar la óptica, confirmar disponibilidad e importe final, realizar el cobro y coordinar el envío. Entiendo que no se ofrece envío gratuito. Muchas gracias.' : 'I look forward to Innova contacting me to review the optical store, confirm availability and final amount, process payment and coordinate shipping. I understand that free shipping is not offered. Thank you.';
